...
namespace BusinessLogic.Entities
{
    public class EntityTimeLapseAlarm : IAlarm
    {
        ...
        public EntityTimeLapseAlarm(Entity entity, TimeSearchMethodType timeSearchMethodType, uint quantityOfTimeToSearchBack, AlarmPosibleState alarmPosibleState, uint quantityOfSentimentsNeeded)
        {
